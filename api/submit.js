...
// Substitui todas as fontes por DejaVu Sans para garantir renderizacao
svg = svg.replace(/font-family=”[^”]*”/g, ‘font-family=“DejaVu Sans”’);
svg = svg.replace(/font-family=’[^’]*’/g, “font-family=‘DejaVu Sans’”);
svg = svg.replace(/font-family:\s*[^;}”’]+/g, ‘font-family: DejaVu Sans’);
return svg;
}
